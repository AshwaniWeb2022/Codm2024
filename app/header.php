...
<link rel="alternate" type="application/rss+xml" title="Local Services Wireframe 4 (Flexbox) | Elementor Kit Library &raquo; Comments Feed" href="comments/feed/index" /> -->
    ...
    <link rel='stylesheet' id='elementor-post-50-css'
        href='https://library.elementor.com/local-services-wireframe-4-flexbox/wp-content/uploads/sites/231/elementor/css/post-50.css?ver=1684379398'
        media='all' />
    <link rel='stylesheet' id='elementor-post-18-css'
    ...
    <link rel="alternate" type="application/json+oembed"
        href="wp-json/oembed/1.0/embed56ec?url=https%3A%2F%2Flibrary.elementor.com%2Flocal-services-wireframe-4-flexbox%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="wp-json/oembed/1.0/embede0c5?url=https%3A%2F%2Flibrary.elementor.com%2Flocal-services-wireframe-4-flexbox%2F&amp;format=xml" />
    <meta name="generator"
    ...
    <meta name="msapplication-TileImage" content="wp-content\favicon_io\android-chrome-512x512.png" />
</head>

<body
    class="home page-template page-template-elementor_header_footer page page-id-71 wp-custom-logo elementor-default elementor-template-full-width elementor-kit-16 elementor-page elementor-page-71">
    <style>
    img.wp-smiley,
    img.emoji {
            ...
            <div class="e-con-inner ">
                <div class="elementor-element elementor-element-444ee561 e-con-full e-con" data-id="444ee561"
                    ...
                    <div class="elementor-element elementor-element-7cc111af elementor-widget elementor-widget-theme-site-logo elementor-widget-image"
                        data-id="7cc111af" data-element_type="widget" data-widget_type="theme-site-logo.default">
                ...
                <div class="elementor-element elementor-element-509ca97d e-con-full e-con" data-id="509ca97d"
                    data-element_type="container" data-settings="{&quot;content_width&quot;:&quot;full&quot;}">
                    <div class="elementor-element elementor-element-f0c4eec elementor-nav-menu--dropdown-mobile elementor-nav-menu--stretch elementor-nav-menu__align-left elementor-widget__width-auto elementor-nav-menu__text-align-aside elementor-nav-menu--toggle elementor-nav-menu--burger elementor-widget elementor-widget-nav-menu"
                        ...
                        <div class="elementor-widget-container">
                            <link rel="stylesheet"
                                href="wp-content/plugins/elementor-pro-3.12.3/assets/css/widget-nav-menu.min.css">
                            <nav
                                ...
                                <ul id="menu-1-f0c4eec" class="elementor-nav-menu">
                                    ...
                                    <div class="dropdown">
                                        <a class="elementor-item" style="padding: 23px;">Company</a>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            <div class="rwo" style="">  
                                                    <!-- <h3>Category 1</h3> -->
                                                    <a href="field-history-tracking">Field History Tracking</a>
                            ...
                            <div class="elementor-menu-toggle" role="button" tabindex="0" aria-label="Menu Toggle"
                                ...
                                <i aria-hidden="true" role="presentation"
                                    class="elementor-menu-toggle__icon--close fa-solid fa-xmark"></i>
                            ...
                            <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container" aria-hidden="true">
                                <ul id="menu-2-f0c4eec" class="elementor-nav-menu">
                                    <li
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-71 current_page_item menu-item-91">
                                        <a href="index" aria-current="page" class="elementor-item"
                                            tabindex="-1">Home</a>
                                    </li>
                                    <li
                                        ...
                                        <li><a class="text-dark elementor-item py-2 px-2" href="about-us">About
                                                    Us</a></li>
                                            <li><a class="text-dark elementor-item py-2 px-2" href="blog">Blogs</a></li>        
                                        </ul>
                                    </li>
                                    <li
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                        ...
                                        <ul class="sub-menu bg-white pt-3 ">
                                            ...
                                            <li><a class="text-dark elementor-item py-2 px-2"
                                                    href="Salesforce-Implementation">Salesforce Implementation</a>
                                            </li>
                                            <li><a class="text-dark elementor-item py-2 px-2"
                                            ...
                                            <li><a class="text-dark elementor-item py-2 px-2"
                                                    href="salesforce-managed-package">Salesforce Managed
                                                    Packages</a></li>
                                            <li><a class="text-dark elementor-item py-2 px-2"
    ...
    <body>
        <div class="marquee-container" onmouseover="stopMarquee()" onmouseout="startMarquee()">
            <div class="marquee-text">
                We recently introduced our new product FHT <a href="field-history-tracking">(Field History
                    Tracking)</a>Application which enables users to track field history of as many fields for an object
                they want .The object can be standard or custom as per users choice.
            </div>
