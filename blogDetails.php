            ...
            <div class="e-con-inner">
                ...
                <div class="elementor-element elementor-element-635e9dbd elementor-widget elementor-widget-theme-post-title elementor-page-title elementor-widget-heading"
                    ...
                    <div class="elementor-widget-container">
                        ...
                        <h1 class="elementor-heading-title elementor-size-default">Create Price Rule in Salesforce CPQ
                            (SBQQ)</h1>
                    </div>
                </div>
                ...
                <div class="elementor-element elementor-element-5b392c56 elementor-widget elementor-widget-theme-post-excerpt"
                    ...
                    <div class="elementor-widget-container">
                        Price Rules are a powerful tool of the Salesforce CPQ. They allow admins to
                        conditionally update the value of just about any field on the quote line, the quote line
                        group, or the quote record itself.
                    </div>
                </div>
                <h4 class="wp-block-heading">Price rule structure:</h4>
                <div class="elementor-element elementor-element-413a808e elementor-widget elementor-widget-theme-post-content"
                    ...
                    <div class="elementor-widget-container">
                        ...
                        <ul>
                            <li>Price Rule</li>
                            <li>Price Condition</li>
                            <li>Price Action</li>
                        </ul>
                        <h4 class="wp-block-heading mt-5">How to Create Price rule in Salesforce CPQ</h4>
                        <p>
                            Consider, Client is running a promotion related to an upcoming trade show. It wants
                            to reduce the price of the Smartblinds product to $125 if sales reps enter “trade
                            show” in the quote’s ReferralCode__c field.
                        </p>
                        <p>Go to App Launcher find the Salesforce CPQ app then click</p>
                        <p>
                            Now click Price Rule Tab</p>

                        <div style="height:100px" aria-hidden="true" class="wp-block-spacer"></div>

                        <div class="wp-block-image size-full">
                            <figure class="aligncenter size-full is-resized"><img decoding="async"
                                    src="wp-content/uploads/sites/231/2022/08/Picture2.png" alt="" class="wp-image-122"
                                    width="858" height="385" /></figure>
                        </div>

                        <p class="mt-2">Put the rule name, evaluation scope, evaluation event and condition.</p>

                        <div class="wp-block-image size-full">
                            <figure class="aligncenter size-full is-resized"><img decoding="async"
                                    src="wp-content/uploads/sites/231/2022/08/Picture3.png" alt="" class="wp-image-122"
                                    width="858" height="385" /></figure>
                        </div>
                        ...
                        <h4 class="wp-block-heading">Step 1: First condition</h4>
                        <p> put the price condition in related list of price rule</p>
                        <div class="wp-block-image size-full">
                            <figure class="aligncenter size-full is-resized"><img decoding="async"
                                    src="wp-content/uploads/sites/231/2022/08/Picture4.png" alt="" class="wp-image-122"
                                    width="858" height="385" /></figure>
                        </div>
                        <p class="mt-2">Select the object and field (I chose tested formula )</p>
                        <div class="wp-block-image size-full">
                            <figure class="aligncenter size-full is-resized"><img decoding="async"
                                    src="wp-content/uploads/sites/231/2022/08/Picture5.png" alt="" class="wp-image-122"
                                    width="858" height="385" /></figure>
                        </div>
                        <p class="mt-2">Put the filter as per given condition</p>

                        <div class="wp-block-image size-full">
                            <figure class="aligncenter size-full is-resized"><img decoding="async"
                                    src="wp-content/uploads/sites/231/2022/08/Picture6.png" alt="" class="wp-image-122"
                                    width="858" height="385" /></figure>
                        </div>
                        <div style="height:100px" aria-hidden="true" class="wp-block-spacer"></div>

                        <h4 class="wp-block-heading">Step 2: second condition</h4>
                        <p>Select object, field and index.</p>
                        <div class="wp-block-image size-full">
                            <figure class="aligncenter size-full is-resized"><img decoding="async"
                                    src="wp-content/uploads/sites/231/2022/08/Picture7.png" alt="" class="wp-image-122"
                                    width="858" height="385" /></figure>
                        </div>
