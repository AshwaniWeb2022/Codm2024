		...
		<div class="row">
			<div class="col-xl-6">
						...
						<div class="card-bx stacked">
							<img src="../mophy/admin/images/card/card.png" alt="" class="mw-100">
							<div class="card-info text-white">
								...
								<!-- <div class="d-flex align-items-center justify-content-between mb-sm-5 mb-3">
									<img src="../mophy/admin/images/dual-dot.png" alt="" class="dot-img">
										...
										<table class="table table-responsive-md card-table previous-transactions">
											<tbody>
												<tr>
													...
													<td>
														<h6 class="fs-16 font-w600 mb-0">
															<a href="TransactionsDetails.html" class="text-black">XYZ
																Store ID</a>
														</h6>
												...
												<tr>
													...
													<td>
														<h6 class="fs-16 font-w600 mb-0">
															<a href="TransactionsDetails.html" class="text-black">Chef
																Renata</a>
														</h6>
													...
													<td>
														<span class="fs-16 text-black font-w500">-$167</span>
													</td>
													<td>
														<span
												...
												<tr>
													...
													<td>
														<h6 class="fs-16 font-w600 mb-0">
															<a href="TransactionsDetails.html" class="text-black">Cindy
																Alexandro</a>
														</h6>
														<span class="fs-14">Transfer</span>
													</td>
												...
												<tr>
													...
													<td>
														<h6 class="fs-16 font-w600 mb-0">
															<a href="TransactionsDetails.html"
																class="text-black">Paipal</a>
														</h6>
														<span class="fs-14">Transfer</span>
													</td>
													<td>
