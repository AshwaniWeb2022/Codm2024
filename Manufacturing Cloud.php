...
<div class="elementor-element elementor-element-635e9dbd elementor-widget elementor-widget-theme-post-title elementor-page-title elementor-widget-heading"
                ...
                <div class="elementor-widget-container">
                    ...
                    <h1 class="elementor-heading-title elementor-size-default elementor-align-center pt-5 ">Manufacturing cloud</h1>
                </div>
            </div>
...
<div data-elementor-type="single-post" data-elementor-id="32"
    ...
    <div class="elementor-element elementor-element-6e8460c3 e-con-boxed e-con" data-id="6e8460c3"
        ...
        <div class="e-con-inner">
            <div class="elementor-element elementor-element-ac9e3f5 elementor-widget elementor-widget-theme-post-featured-image elementor-widget-image"
                ...
                <div class="elementor-widget-container">
                    <img width="800" height="650"
                        src="wp-content/uploads/sites/231/2022/08/hand-drawn-flat-design-sql-illustration_23-2149242071.avif"
            ...
            <div class="elementor-element elementor-element-5b392c56 elementor-widget elementor-align-center elementor-widget-theme-post-excerpt"
                ...
                <div class="elementor-widget-container">
                    The next generation of manufacturing is Here
                </div>
            </div>
        </div>
    </div>
    <div class="ms-5 me-5">
        ...
        <p>Salesforce Manufacturing Cloud is a new solution designed specifically for manufacturers to unify
            account planning and forecasting, providing greater visibility and collaboration across their
            ecosystem.

            Manufacturing is a critical cog in the global economy. In the U.S., it employs over 12 million
            people and contributes about $2 trillion to GDP. Globally, output in the 34 largest
            manufacturing regions totals over $35 trillion. This sector is also on the cusp of new
            productivity, efficiency and innovation as technology ushers in the next generation of
            manufacturing based on a connected ecosystem and smart analytics. We intend to drive this
            transformation with Salesforce Manufacturing Cloud, a new solution designed specifically for
            manufacturers to unify account planning and forecasting, providing greater visibility and
            collaboration across their ecosystem. This unified view provides a clear picture of
            manufacturing customers through new sales agreements and account-based forecasting solutions
            that enable them to accurately forecast, plan and deliver predictable (and better) business
            results.</p>
        ...
        <p>
            Success in the manufacturing industry depends on great products and meeting customer demand through
            efficient production and fulfillment of those products. The first step in this process is to ensure that
            customer teams have an overview of a customer's entire business scope. This includes ongoing business,
            run-rate business and new opportunities. This visibility leads to more accurate forecasting, more
            predictable business, and ultimately more revenue.

            Predictability is paramount for all stakeholders in the production system. Customers want certainty in
            pricing, availability and delivery; distributors want optimized delivery channels; sales teams want pricing
            based on real-time volume assumptions; and operations teams want to produce and procure components based on
            the most accurate demand possible.

            To achieve this, manufacturers need a clear understanding of all past shipments, current production plans,
            and future production forecasts. The challenge most face is information silos across multiple systems,
            including CRM, ERP, and supply chain planning systems. On top of that, there are usually various teams
            involved, which bogs down the process and makes the sales and operations process murky at best. Perhaps
            worst of all, sales and distribution partners — those closest to the customer — are not accurately
            represented!

            Given the current manufacturing ecosystem, there is now a golden opportunity to link customers, distribution
            partners, and sales teams to change the operational planning paradigm. The next generation of manufacturing
            leaders will establish a new level of connection and engagement with their customers. Achieving this
            requires universal access to previously siloed data and the ability to extract insights from that data. One
            manufacturer recently told me that these advancements portend a shift from acting on the point of view of
            the customer to the actual needs of the customer.
        </p>
        <div class=" elementor-element elementor-element-5b392c56 elementor-widget elementor-widget-theme-post-excerpt"
            data-id="5b392c56" data-element_type="widget" data-widget_type="theme-post-excerpt.default">
            <div class="elementor-widget-container pt-5">
        ...
        <p>
            We introduced Manufacturing Cloud to streamline the alignment between sales and operations, revamp the sales
            forecasting process for both ongoing business and new opportunities, and extend the planning collaboration
            to our partners. Here's a breakdown of how it works.

            Sales agreements provide manufacturers with the means to consolidate ongoing business data from ERP and OMS
            systems alongside negotiated contract terms, encompassing planned volumes and revenue. This ensures that
            both our operations and account teams have a comprehensive 360-degree view of our customers. Any
            modifications are automatically integrated into the sales agreement, ensuring a single, authoritative source
            of information. Our account teams now possess the capability to oversee the complete sales agreement
            lifecycle, gaining insights into committed and actual order volumes. Additionally, they can monitor the
            agreement's performance against the forecast and other customized time-phased metrics.

            Our account-based forecasting approach fosters collaboration across the entire organization, breaking down
            internal barriers that have traditionally hindered accurate forecasting. This empowers our sales, finance,
            and operations teams to generate more precise forecasts. Our account teams can also contribute updates
            regarding evolving customer needs and broader market trends, allowing us to adapt plans and estimates in
            real-time, thereby enhancing the predictability of our business transactions, profits, and revenues.

            Many manufacturers distribute their products through a network of distributors and dealers who possess
            valuable insights into changing customer preferences and market demands. To harness this valuable knowledge,
            we've integrated them into the forecast collaboration process through a pre-configured community template.

            This groundbreaking capability equips manufacturers with unparalleled access to real-time insights
            concerning customer behavior, product performance, and pricing dynamics, enabling swift translation of these
