        ...
        <div class="container-fluid ">
            <div class="row">
                <div class="col-lg-7 mb-5">
                    <h2 class="pt-5 heading_titel">Benefits of Salesforce Omni Studio </h2>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    Salesforce allows businesses to have a comprehensive view of their customers,
                                    including their contact information, interactions, purchase history, and
                                    preferences. This helps in providing personalized services.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Salesforce provides tools for lead management, email marketing, and analytics, which
                                    can help organizations streamline their sales and marketing efforts.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    The platform offers features for managing customer support cases, tracking customer
                                    inquiries, and providing self-service options, leading to improved customer
                                    satisfaction.
                                </div>
                            </div>
                        </div>
