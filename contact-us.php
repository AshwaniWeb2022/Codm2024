...
<div data-elementor-type="wp-page" data-elementor-id="50" class="elementor elementor-50">
    <div class="elementor-element elementor-element-7faf9f0c e-con-full e-con" data-id="7faf9f0c"
        ...
        <div class="elementor-element elementor-element-5606a1d9 e-con-full e-con" data-id="5606a1d9"
            data-element_type="container"
            data-settings="{&quot;content_width&quot;:&quot;full&quot;,&quot;background_background&quot;:&quot;classic&quot;}">
            <div class="elementor-element elementor-element-2cf1c637 elementor-widget elementor-widget-heading"
                data-id="2cf1c637" data-element_type="widget" data-widget_type="heading.default">
            ...
            <div class="elementor-element elementor-element-f9715de elementor-widget elementor-widget-heading"
                data-id="f9715de" data-element_type="widget" data-widget_type="heading.default">
                <div class="elementor-widget-container">
                                ...
                                <div class="accordion-body">
                                    <div class="accordionAddress">
                                        <div style="float: left; width: 70%;">
                                            <img src="wp-content\uploads\sites\231\2022\08\2807791_18166.jpg"
                                                alt="uk Flag" style="height:60px;"><br />
                                        ...
                                        <div style="float: right; width: 30%;"><img loading="lazy" loading="lazy"
                                                ...
                                                src="wp-content\uploads\sites\231\2022\08\UKlocation.svg"
                        ...
                        <div class="accordion-item">
                            <div id="collapseTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="accordionAddress">
                                        <div style="float: left; width: 70%;">
                                            <img src="wp-content\uploads\sites\231\2022\08\2807790_18165.jpg"
                                                alt="usa Flag" style="height:60px;"><br />
                                            <a href="https://www.google.com/maps/search/Talent4World+LLC+4501+Nightland+Dr+Plano/@33.0841252,-96.7826552,17z/data=!3m1!4b1?entry=ttu"
                                                target="_blank" rel="noopener">
                                                <span class="address-content"><br />Talent4World LLC<br /> 4501
                                                    Nightland <br /> Dr
                                                    Plano, <br /> TX 75024 - USA</span></a><br /><br />
                                            <div class="footerMailPhoneIcon ">
                                                <!-- <i class="fa-solid fa-phone text-info"></i> -->
                                            ...
                                            <div class="footerMailPhoneIcon">
                                                <!-- <i class="fa-sharp fa-solid fa-envelope text-info"></i> -->
                                                <a href="mailto:info@tech14networks.com"
                                                    class="text-dark">info@talent4world.com</a>
                                            </div>
                                        </div>
                                        <div style="float: right; width: 30%;"><img loading="lazy" loading="lazy"
                                                decoding="async" class="align none size-medium wp-image-15730"
                                                role="img" src="wp-content\uploads\sites\231\2022\08\usa logo.svg"
                                                alt="CodM USA Office Address" width="154" height="133" />
                                        </div>
        ...
        <!-- Accordion ends -->
        <div class="elementor-element elementor-element-4f81c598 e-con-full e-con" data-id="4f81c598"
            data-element_type="container" data-settings="{&quot;content_width&quot;:&quot;full&quot;}">
            <div class="elementor-element elementor-element-4db6c19f elementor-button-align-start elementor-tablet-button-align-center elementor-widget elementor-widget-form"
                data-id="4db6c19f" data-element_type="widget"
                ...
                <div class="elementor-widget-container">
                    ...
                    <form class="elementor-form" method="post" name="Contact Form">
                        ...
                        <input type="hidden" name="referer_title"
                            value="Contact Us - Local Services Wireframe 4 (Flexbox) | Elementor Kit Library" />
                        ...
                        <div class="elementor-form-fields-wrapper elementor-labels-">
                            <div
                                ...
                                <input size="1" type="text" name="form_fields[name]" id="form-field-name"
                                    ...
                                    placeholder="Your Name*" required="required" aria-required="true">
                            </div>
                            <div
                                class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_b743cd7 elementor-col-50 elementor-field-required">
                                <label for="form-field-field_b743cd7"
                                    class="elementor-field-label elementor-screen-only">
                                    Last Name </label>
                                <input size="1" type="text" name="form_fields[field_b743cd7]"
                                    id="form-field-field_b743cd7"
                                    class="elementor-field elementor-size-sm  elementor-field-textual"
                                    placeholder="Last Name*" required="required" aria-required="true">
                            </div>
                            <div
                                class="elementor-field-type-tel elementor-field-group elementor-column elementor-field-group-field_6c180a9 elementor-col-50 elementor-field-required">
                                <label for="form-field-field_6c180a9"
                                    class="elementor-field-label elementor-screen-only">
                                    Phone Number </label>
                                <input size="1" type="tel" name="form_fields[field_6c180a9]"
                                    id="form-field-field_6c180a9"
                                    class="elementor-field elementor-size-sm  elementor-field-textual"
