                    ...
                    <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="accordionAddress">
                                        <div style="float: left; width: 70%;">
                                            <img src="https://codmsoftware.com/assect/upload/contact/flag-uk.webp"
                                                alt="uk Flag"><br />
                                            <a href="https://maps.app.goo.gl/CMrbZUDyUKPzHcEj7" target="_blank"
                                                rel="noopener">
                                                <span class="address-content"><br />Spaces - Birmingham,<br /> The
                                                    Mailbox
                                                    Level 1, The Mailbox, 3 <br />
                                                    Wharfside Street Spaces, Birmingham B1 1RD,<br /> United
                                                    Kingdom</span></a><br /><br />
                                        </div>
                                        ...
                                        <div class="footerMailPhoneIcon">
                                            ...
                                            <a href="mailto:hr@Codmsoftware.com"
                                                class="text-dark">info@codmsoftware.com</a>
                                        </div>
                                        <div class="footerMailPhoneIcon">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="accordion-body">
                                    <div style="float: left; width: 70%;">
                                        <img src="https://codmsoftware.com/assect/upload/contact/usa_flag.png"
                                            alt="usa Flag"><br />
                                        <a href="https://www.google.com/maps/search/Talent4World+LLC+4501+Nightland+Dr+Plano/@33.0841252,-96.7826552,17z/data=!3m1!4b1?entry=ttu"
                                            ...
                                            <span class="address-content"><br />Talent4World LLC<br /> 4501 Nightland
                                                <br /> Dr
                    ...
                    <div class="elementor-form-fields-wrapper elementor-labels-">
                        ...
                        <div
                            ...
                            <label for="form-field-field_b743cd7" class="elementor-field-label elementor-screen-only">
                                Last Name </label>
                            <input size="1" type="text" name="form_fields[field_b743cd7]" id="form-field-field_b743cd7"
                                class="elementor-field elementor-size-sm  elementor-field-textual"
                        ...
                        <div
                            ...
                            <label for="form-field-field_6c180a9" class="elementor-field-label elementor-screen-only">
                                Phone Number </label>
                            <input size="1" type="tel" name="form_fields[field_6c180a9]" id="form-field-field_6c180a9"
                                class="elementor-field elementor-size-sm  elementor-field-textual"
